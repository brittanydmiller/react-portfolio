...
const TechList = ({techs, css_images}) => {
  const technologies = {
    ...
    'js5':  { src:"js5.png", alt:"JavaScript and jQuery", width:"36px", height:"50px"},
    'js': { src: "js.png", alt:"JavaScript", width:"36px", height:"50px"},
    'js6': { src:"js6.png", alt:"JavaScript", width:"36px", height:"50px"},
    'reactjs': {src: "reactjs.png", alt:"ReactJS", width:"40px", height:"50px"},
