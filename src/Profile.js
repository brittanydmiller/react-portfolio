	...
	return(
	  <div id="about-me">
	    <div class="offset" class="clear">
	      ...
	      <ul id="social">
	        <li><a id="github" href="https://github.com/brittanydmiller"><img src="css/github.png" alt="Github" width="32px" height="32px" /></a></li>
	        <li><a id="linkedin" href="https://www.linkedin.com/in/brittanydmiller"><img src="css/linkedin.png" alt="LinkedIn" width="32px" height="32px" /></a></li>
	        <li id="artsResume" class="resume"><a target="_blank" href="https://docs.google.com/document/d/e/2PACX-1vTzz7r_ER6L0aRjeEE9QH5gBT0KfbQ5krtzzaBqLr4R-IevsRzdmtkQUi6rnxgkozEg6GFG7vTEd6Or/pub">Arts Resume</a></li>
	        <li id="techResume" class="resume"><a target="_blank" href="https://docs.google.com/document/d/e/2PACX-1vTd-gf8auHGV57Hxv2KEYsZRBhFtLG4fSWz7GvEYe9uP649QpAvtFcHuwTewRL8ZTAK9KWevbhPMBr3/pub">Tech Resume</a></li>
	      </ul>
	    </div>
	  </div>
	);
