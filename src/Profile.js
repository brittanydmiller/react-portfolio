...
const Profile = ({images, css_images}) => {
	return(
	  <div id="about-me">
	    <div className="offset clear">
	      ...
	      <ul id="social">
	        <li><a id="github" target="_blank" rel="noopener noreferrer" href="https://github.com/brittanydmiller"><img src={css_images['github.png']} alt="Github" width="32px" height="32px" /></a></li>
	        <li><a id="linkedin" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/brittanydmiller"><img src={css_images['linkedin.png']} alt="LinkedIn" width="32px" height="32px" /></a></li>
